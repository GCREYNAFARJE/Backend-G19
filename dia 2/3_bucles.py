...
for numero in range(5):
    if numero == 3:
        continue # detiene la iteracion actual y no permite que se ejecute el codigo restante Pero no acaba la iteracion como break
    print(numero)

def mostrar_alumnos():
# si de momento no tenemos una logica planeada para nueste funcion, if, else, for, while, etc o cualquier bloque de codigo podemos usar 
 pass
# {}